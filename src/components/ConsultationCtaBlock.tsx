...
// until the Move Planning Consultation became a paid, $100 booking; kept the
    ...
    <section className="bg-sand py-16 sm:py-24">
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 font-display text-5xl font-bold leading-none text-navy sm:text-6xl">$100</p>
