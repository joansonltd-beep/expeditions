...
export const DEFAULT_BUSINESS_SETUP: BusinessSetupPage = {
  ...
  establishmentParagraphs: [
    "Under Chapter Three of the Revised Treaty of Chaguaramas, CARICOM nationals have the Right of Establishment: the right to set up and run a business in any other member state. It covers non-wage-earning activity of a commercial, industrial, agricultural, professional or artisanal nature, and the right to create and manage economic enterprises. It applies to companies as well as individuals, as long as the business is at least 50% owned by CARICOM nationals.",
